...
class TrainingLogApp:
    ...
    def create_widgets(self):
        ...
        self.view_button = ttk.Button(self.root, text="Просмотреть все записи", command=self.view_records)
    ...
    def add_entry(self):
        """
        Считывает данные из полей ввода, проверяет их наличие, создает словарь с информацией о тренировке,
    ...
    def view_records(self):
        """
        загружает сохраненные данные и отображает их в новом окне с помощью виджета Treeview. Для каждой
    ...
    def load_exercise(self):
        """
        Загружает список упражнений из JSON-файла.
        """
        data = load_data()
        for entry in data:
            if entry['exercise'] == self.view_exercise_entry.get():
